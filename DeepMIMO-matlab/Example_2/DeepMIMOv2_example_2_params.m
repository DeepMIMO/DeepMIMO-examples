...
params.active_user_last = 2;        % The last row of the considered user section (check the scenario description for the user row map)
...
params.num_ant_BS = [[1, 8, 4]      % Number of the UPA antenna array on the x,y,z-axes for the active BSs
                    [1, 4, 4]];        
...
params.activate_array_rotation = 1; % 0 -> no array rotation - 1 -> apply the array rotation defined in params.array_rotation_BS and params.array_rotation_UE 
params.array_rotation_BS = [0, 0, -20];         
...
params.array_rotation_UE = [0, 20, 0];      
...
params.ant_spacing_BS = [0.5 0.7];    % ratio of the wavelength; for half wavelength enter .5
